...
Professional.create(user: user2, speciallity: "Nutrición Clínica", adress: "Cuernavaca, Av. Cuauhtemoc Plaza Romanza", diploma: "10206006", first_cost: 400, follow_cost: 150)

user3 = User.create(name:"Nivia", lastname: "Esquivel", phone: "7772073576", password: "6555940", email: "diaxesquivel@gmail.com")
Professional.create(user: user3, speciallity: "Nutrición Clínica, Educadora en Diabetes ", adress: "Cuernavaca, Av. Sn Diego 1203. CP 62330", diploma: "6555940", first_cost: 600, follow_cost: 400)
