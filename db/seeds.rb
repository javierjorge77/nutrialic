...
user1.save!
professional1= Professional.new(user: user1, branch: "Nutrición Clínica", adress: " Cuautla, Morelos", diploma: "10206015", first_cost: 500, follow_cost: 350, startAttendingTime: Time.parse("Sat, 01 Jan 2000 10:00:00.000000000 UTC +00:00"),   endAttendingTime: Time.parse("Sat, 01 Jan 2000 17:00:00.000000000 UTC +00:00"))
...
user2.save!
professional2= Professional.new(user: user2, branch: "Nutrición Clínica", adress: "Villahermosa", diploma: "10206006", first_cost: 400, follow_cost: 150, startAttendingTime: Time.parse("Sat, 01 Jan 2000 10:00:00.000000000 UTC +00:00"),   endAttendingTime: Time.parse("Sat, 01 Jan 2000 17:00:00.000000000 UTC +00:00"))
...
user5.save!
professional5= Professional.new(user: user5, branch: "Nutrición Clínica, Obesidad, Educación en Diabetes", adress: "Chiapas", diploma: "11977457", first_cost: 450, follow_cost: 350, startAttendingTime: Time.parse("Sat, 01 Jan 2000 10:00:00.000000000 UTC +00:00"), endAttendingTime: Time.parse("Sat, 01 Jan 2000 17:00:00.000000000 UTC +00:00"))
...
user4.save!
professional4= Professional.new(user: user4, branch: "Obesidad", adress: "Torreón", diploma: "8062690", first_cost: 600, follow_cost: 400, startAttendingTime: Time.parse("Sat, 01 Jan 2000 10:00:00.000000000 UTC +00:00"),   endAttendingTime: Time.parse("Sat, 01 Jan 2000 17:00:00.000000000 UTC +00:00"))
...
user3.save!
professional3= Professional.new(user: user3, branch: "Nutrición Clínica", adress: "Puebla,Puebla", diploma: "13065988", first_cost: 500, follow_cost: 400, startAttendingTime: Time.parse("Sat, 01 Jan 2000 10:00:00.000000000 UTC +00:00"),   endAttendingTime: Time.parse("Sat, 01 Jan 2000 17:00:00.000000000 UTC +00:00"))
...
user6.save!
professional6= Professional.new(user: user6, branch: "Nutrición Clínica", adress: "Ciudad de México", diploma: "11776428", first_cost: 700, follow_cost: 600, startAttendingTime: Time.parse("Sat, 01 Jan 2000 10:00:00.000000000 UTC +00:00"),   endAttendingTime: Time.parse("Sat, 01 Jan 2000 17:00:00.000000000 UTC +00:00"))
...
user7.save!
professional7= Professional.new(user: user7, branch: "Diabetólogo", adress: "Toluca", diploma: "11474526", first_cost: 650, follow_cost: 500, startAttendingTime: Time.parse("Sat, 01 Jan 2000 10:00:00.000000000 UTC +00:00"), endAttendingTime: Time.parse("Sat, 01 Jan 2000 17:00:00.000000000 UTC +00:00"))
...
user8.save!
professional8= Professional.new(user: user8, branch: "Nutrición Clínica", adress: "Toluca", diploma: "7302686", first_cost: 450, follow_cost: 400, startAttendingTime: Time.parse("Sat, 01 Jan 2000 10:00:00.000000000 UTC +00:00"),   endAttendingTime: Time.parse("Sat, 01 Jan 2000 17:00:00.000000000 UTC +00:00"))
...
user9.save!
professional9= Professional.new(user: user9, branch: "Nutrición Clínica", adress: "Monterrey", diploma: "7109529", first_cost: 800, follow_cost: 600, startAttendingTime: Time.parse("Sat, 01 Jan 2000 10:00:00.000000000 UTC +00:00"),   endAttendingTime: Time.parse("Sat, 01 Jan 2000 17:00:00.000000000 UTC +00:00"))
...
user10.save!
professional10= Professional.new(user: user10, branch: "Nutrición Clínica, Médico Cirujano, Educadora en Diabetes ", adress: "Cuernavaca", diploma: "6555940", first_cost: 600, follow_cost: 400, startAttendingTime: Time.parse("Sat, 01 Jan 2000 10:00:00.000000000 UTC +00:00"),   endAttendingTime: Time.parse("Sat, 01 Jan 2000 17:00:00.000000000 UTC +00:00"))
